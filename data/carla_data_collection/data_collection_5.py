...
def main():
    ...
    parser.add_argument('--enable_npc', action='store_true', help='Enable NPC vehicle to simulate dangerous driving')
    ...
    try:
        ...
        traffic_manager.vehicle_percentage_speed_difference(vehicle, 10)  # Ego vehicle goes 10% slower than speed limit
        ...
        if args.enable_npc:
            ...
            if npc_spawn_waypoint:
                # get a waypoint 4 meters behind the ego vehicle
                distance = 4  # meters
                ...
                if npc_spawn_waypoints:
                    ...
                    npc_spawn_transform.location.z += 0.5
                    ...
                    if npc_vehicle is None:
                        ...
                        traffic_manager.vehicle_percentage_speed_difference(npc_vehicle, -60)  # NPC vehicle goes 10% faster than speed limit
        ...
        # let the vehicles move for 5 seconds before data collection starts
        print("Vehicles are moving for 5 seconds before data collection starts...")
        for _ in range(int(4 * args.fps)):
            snapshot = world.tick()
