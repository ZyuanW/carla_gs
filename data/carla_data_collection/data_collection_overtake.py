...
def main():
    ...
    try:
        ...
        traffic_manager.vehicle_percentage_speed_difference(vehicle, 20)  # Ego vehicle goes 10% slower than speed limit
        ...
        if args.overtake:
            ...
            if npc_spawn_waypoint:
                ...
                if npc_spawn_waypoints:
                    ...
                    npc_spawn_transform.location.x += 0  # adjust the x
                    npc_spawn_transform.location.y += -3  # adjust the y
        ...
        wait_for_data_collection = 4  # seconds
